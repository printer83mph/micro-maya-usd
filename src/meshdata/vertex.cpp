...
Vertex::Vertex(glm::vec3 pos) : pos(pos), id(nextId++),
      joint1Idx(0), joint2Idx(0), joint1Weight(1.f), joint2Weight(0.f)
{
...
void Vertex::assignWeights(std::vector<Joint*>& joints)
{
    ...
    {
        glm::vec3 jointPos = glm::vec3(joint->getOverallTransform() * glm::vec4(0, 0, 0, 1));
