...
private:
     ...
     * @param faces - face data, where each inner vector is 0-indexed vertices of one face
     */
    ...
    bool containsVertex(Vertex* vert) const;  // Check to see if a Vertex pointer is part of this mesh.
    bool containsFace(Face* face) const;      // Check to see if a Face pointer is part of this mesh.
    bool containsEdge(HalfEdge* edge) const;  // Check to see if a HalfEdge pointer is part of this mesh.
